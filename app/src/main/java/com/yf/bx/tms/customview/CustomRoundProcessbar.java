...
public class CustomRoundProcessbar extends View {
    ...
    public CustomRoundProcessbar(Context context) {
        this(context, null);
    }

    public CustomRoundProcessbar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomRoundProcessbar(Context context, AttributeSet attrs, int defStyle) {

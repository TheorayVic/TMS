...
import com.yf.bx.tms.adapter.YhpjAdapter;
...
public class YhpjFragment extends Fragment implements View.OnClickListener{

    private final static String TAG = "YhpjFragment";
    private View view;
    private ListView lv_gdcl;
    private TextView tv_pj,tv_tj;
    private CheckBox cb_gdcl;
    private YhpjAdapter adapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        cb_gdcl = (CheckBox) view.findViewById(R.id.cb_yhpj);
        lv_gdcl = (ListView) view.findViewById(R.id.listview_yhpj);
        tv_pj = (TextView) view.findViewById(R.id.tv_yhpj_pj);
...
//        list.add("测试数据2");
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.tv_yhpj_pj:
                if (len!=1){
                    handler.sendEmptyMessage(1);
                }else{
                    if (null!=onAddClick){
                        //带数据进入
                        onAddClick.onClick(tv_pj);
                    }}
                break;
            case R.id.tv_yhpj_tj:
                if (len==0){

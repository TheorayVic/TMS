...
public class HxclFragment extends Fragment implements View.OnClickListener{
    ...
    private List<String> list_jdwtlx = new ArrayList<>();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter_cljg = new ArrayAdapter<String>(getActivity(),
                android.R.layout.simple_dropdown_item_1line,list_cljg);
        spinner_jjcd.setAdapter(adapter_jjcd);
        spinner_wtlx.setAdapter(adapter_wtlx);
        spinner_jdwtlx.setAdapter(adapter_wtlx);
        spinner_cljg.setAdapter(adapter_cljg);
